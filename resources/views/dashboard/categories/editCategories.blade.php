...
@section('title','eCommerce | Edit Category')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('admin.mainCategories') }}">Categories</a></li>
          ...
          <div class="card card-secondary">
            ...
            <div class="card-body">
                ...
                <form class ="form" action="{{ route('admin.mainCategories.update',$category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <img style="height: 40vh " src="{{ url($category->photo) }}" class="img-circle elevation-2 height-150" alt="Category Image" >
                </div>
